...
class FM_Transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM_Transmitter", catch_exceptions=True)
        ...
        self.osmosdr_sink_0.set_sample_rate(samp_rate * 5 * 25)
        self.osmosdr_sink_0.set_center_freq(1045e5, 0)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/kali/PBL/01_FM_Transmitter/bingo.wav', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.osmosdr_sink_0.set_sample_rate(self.samp_rate * 5 * 25)
